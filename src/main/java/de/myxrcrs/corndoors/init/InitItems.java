...
public class InitItems {
    ...
    public static final RegistryObject<BlockItem> D_NAIVE_DOOR_GLASS = ITEMS.register("d_naive_door_glass",()->new NaiveDoorItem(DoorWindowType.GLASS,InitBlocks.D_NAIVE_DOOR_EDGE.get()));
    public static final RegistryObject<BlockItem> D_NAIVE_DOOR_FILM = ITEMS.register("d_naive_door_film",()->new NaiveDoorItem(DoorWindowType.FILM,InitBlocks.D_NAIVE_DOOR_EDGE.get()));
    public static final RegistryObject<BlockItem> D_NAIVE_DOOR_NONE = ITEMS.register("d_naive_door_none",()->new NaiveDoorItem(DoorWindowType.NONE,InitBlocks.D_NAIVE_DOOR_EDGE.get()));
}